...
Т.е. $n$ должно быть равным \approx 22335, чтобы в долгосрочной серии экспериментов по вычислению интеграла заданной функции по методу Монте-Карла получить истинное значение с точностью 0.001 и с вероятностью 0.997.
